...
(async function () {
    try {
        let response = await fetch("http://localhost:8081/04-rest-learn/departments");
...
async function addEmployee() {
    ...
    try {
        let response = await fetch("http://localhost:8081/04-rest-learn/employees", options);
